...
<body>
		...
		<div class="cuerpo">
			...
			<h2><span class="icon-main"></span> Boton Materiales</h1>
			<img src="../imagenes/manual/boton_materiales.png" class="imgn">
			<h2><span class="icon-main"></span> Boton Producto</h1>
			<img src="../imagenes/manual/boton_productos.png" class="imgn">
			<h2><span class="icon-main"></span> Boton Proveedor</h1>
			<img src="../imagenes/manual/boton_proveedor.png" class="imgn">
