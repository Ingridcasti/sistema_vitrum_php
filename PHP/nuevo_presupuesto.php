...
<head lang="en">
	...
	<link rel="stylesheet" type="text/css" href="../CSS/nuevo_presupuesto.css">
	<link rel="stylesheet" type="text/css" href="../ico_fonts.css">
	<link rel="stylesheet" type="text/css" href="../CSS/nivo-slider.css">
	<script src="../JS/presu.js"></script>
...
<body>
	    ...
	    <div class="contenedor">
	    	<div class="caja1">
	    		<form action="calculos_pre.php" method="post" onsubmit="return validar(this);"> 
