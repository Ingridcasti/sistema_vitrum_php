...
<body>
		...
		<div class="cuerpo">
			...
			<h2><span class="icon-main"></span> Boton Agregar Usuario</h1>
			<img src="../imagenes/manual/boton_crear_usuario.png" class="imgn">
			<h2><span class="icon-main"></span> Boton Nuevo Presupuesto</h1>
			<img src="../imagenes/manual/boton_nuevo_presupuesto.png" class="imgn">
			<h2><span class="icon-main"></span> Boton Configuracion</h1>
			<img src="../imagenes/manual/boton_configuracion.png" class="imgn">
