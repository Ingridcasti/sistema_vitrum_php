...
<header>
	...
	<body>
	    ...
	    <div class="cuerpo">  
          <div class="cuadro">
            <h2 class="icon-slideshare"> Clientes</h2>
              <div class="tbla">
                  <table cellpadding="10">
                    <thead>
                      	<tr>
                        	...
                        	<th>Telefonos Del Cliente</th>
                        	<th>Dirección Del Cliente</th>
                        	<th>Id_Empleado_Registro</th>
                        	<th>Codigo Pedido</th>
                        	<th>Total</th>
                    ...
                    <tbody>
	                    ...
	                    ?>
	                        ...
	                        <td><?php echo $filas['telefono_cliente'];?> </td>
	                        <td><?php echo $filas['direccion_instalacion'];?> </td>
	                        <td><?php echo $filas['id_empleado_registro'];?> </td>
