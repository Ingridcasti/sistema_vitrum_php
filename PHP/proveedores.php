...
<header>
	...
	<body>
	    ...
	    <div class="cuerpo">  
          <div class="cuadro">
          	<a href="nuevo_proveedor.php" class="icon-circle-with-plus"> Nuevo Proveedor</a>
            <h2 class="icon-shopping-cart"> Proveedores</h2>
              <div class="tbla">
                  <table cellpadding="10">
                    ...
                    <script type="text/javascript">
                    	function feliminar()
                    	{
                    		var resp = confirm(" Estas seguro que desea Eliminar el Proveedor?");
                    		if (resp == true) 
                    		{
                    			return true
                    		}
                      	...
                      	<?php
	                   	...
	                   	?>
	                          <tr>
	                        		<td><a href="modificar_proveedor.php?id_proveedor=<?php echo $filas['id_proveedor'] ?>"> <button type='button' class='btn btn-success'>Modificar</button> </a></td>
	                        		<td><a href="funciones.php?id_proveedor=<?php echo $filas['id_proveedor'] ?>"> <button type='button' class='btn btn-danger' onclick = "return feliminar();">Eliminar</button> </a></td>
	                        	    <td> <?php echo $filas['id_proveedor'];?></td>
	                        	    <td> <?php echo $filas['nombre_proveedor'];?></td>
	                        	    <td> <?php echo $filas['descripcion_proveedor'];?></td>
