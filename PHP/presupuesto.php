...
<header>
	...
	<body>
	    ...
	    <div class="cuerpo">  
          <div class="cuadro">
          	<a href="nuevo_presupuesto.php" class="icon-circle-with-plus"> Nuevo Presupuesto</a>
            <h2 class="icon-new-message"> Presupuestos</h2>
              <div class="tbla">
                  <table cellpadding="10">
                    ...
                    <tbody>
	                    ...
	                    ?>    
	                        <tr>
	                        	<td><a href="pdf.php?cod_presupuesto=<?php echo $filas['cod_presupuesto'] ?>"> <button type='button' class='btn btn-active' onclick = "return factivar();">Imprimir</button></a></td>
	                        	<td><?php echo $filas['cod_presupuesto'];?> </td>
	                        	<td><?php echo $filas['precio_uni']?> </td>
	                       		<td><?php echo $filas['presupuesto_externo'];?> </td>
