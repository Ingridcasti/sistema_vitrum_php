...
<header>
	...
	<body>
	    ...
	    <div class="cuerpo">  
          <div class="cuadro">
          	<a href="nuevo_producto.php" class="icon-circle-with-plus"> Nuevo Producto</a>
            <h2 class="icon-archive"> Productos</h2>
              <div class="tbla">
                  <table cellpadding="10">
                    ...
                    <tbody>
                    	<?php
	                   	...
	                   	?>
	                          <tr>
	                        		<td><a href="modificar_producto.php?codigo_productos=<?php echo $filas['codigo_productos']?>"> <button type='button' class='btn btn-success'>Modificar</button> </a></td>
	                        		<td> <?php echo $filas['codigo_productos'];?></td>
