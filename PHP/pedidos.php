...
<header>
	...
	<body>
	    ...
	    <div class="cuerpo">  
          <div class="cuadro">
          	<a href="nuevo_pedido.php" class="icon-circle-with-plus"> Nuevo Pedido</a>
            <h2 class="icon-shopping-basket"> Pedidos</h2>
              <div class="tbla">
                  <table cellpadding="10">
                    ...
                    <tbody>
	                    ...
	                    ?>    
	                        <tr>
	                        	<td><a href="pdf_p.php?codigo_pedido=<?php echo $filas['codigo_pedido'] ?>"> <button type='button' class='btn btn-active' onclick = "return factivar();">Imprimir</button></a></td>
	                        	<td><?php echo $filas['codigo_pedido'];?> </td>
	                        	<td><?php echo $filas['direccion_instalacion']?> </td>
	                        	<td><?php echo $filas['cantidad_pedido'];?> </td>
