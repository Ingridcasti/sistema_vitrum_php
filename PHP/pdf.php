<?php
  ...
  @  $consulta=ConsultarEmpleado($_GET['cod_presupuesto']);
  function ConsultarEmpleado($cod_pr)
  {
    require("Conexion.php");
    $sql = "SELECT * FROM presupuestos WHERE cod_presupuesto = '".$cod_pr."'";
    $resultado = $mysqli -> query($sql);
    $filas = $resultado -> fetch_array(MYSQLI_BOTH);
    return [
      $filas['precio_uni'],
      $filas['presupuesto_externo'],
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="total"><?php echo $consulta[0]; ?></td>
          </tr>
          <tr>
            <td>CANTIDAD</td>
            <td class="total"></td>
          ...
          <tr>
            ...
            <td class="grand total"><?php echo $consulta[1]; ?></td>
          </tr>
        </tbody>
      </table>
