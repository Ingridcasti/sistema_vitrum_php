...
$total=($subtotal*$cantidad);
 ...
 return $key;
     ...
     $sql1=mysqli_query($mysqli, "INSERT INTO presupuestos(cod_presupuesto, precio_uni, presupuesto_externo, codigo_producto, id_empleado) VALUES ('$codigop', '$subtotal', '$total', '$codi','$_SESSION[id_usuario]')");
     echo "<script> alert('Presupuesto creado con éxito'); window.location= 'nuevo_presupuesto.php'</script>"; 
